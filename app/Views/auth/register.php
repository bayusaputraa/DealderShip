            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class="form-control <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" name="username" placeholder="<?=lang('Auth.username')?>" value="<?= old('username') ?>" id="inputLastName" type="text" name="username" placeholder="<?=lang('Auth.username')?>" />
                                        <label for="inputLastName"><label for="username"><?=lang('Auth.username')?></label>
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer text-center py-3">
                        <div class="small"><a href="<?= base_url('login')?>">Sudah Memiliki Akun? Ayo login!</a></div>
                    </div>
                </div>
            </div>
        </div>
